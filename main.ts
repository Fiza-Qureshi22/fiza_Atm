...
async function main() {
  ...
  const accountNumber: keyof typeof accountBalances = userInput.accountNumber;


  const  anotherAccountNumber: string  = userInput.accountNumber;
